...
import { MessageSquare, Users, Calendar, Trophy, ArrowRight, Share2, Heart } from 'lucide-react';
      ...
      <section className="bg-brand-dark text-white py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-1.5 rounded-full mb-6 border border-white/20">
            ...
            <span className="text-sm font-medium tracking-wide">Comunidade Global</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
            Aprender é melhor <span className="text-brand-accent">juntos</span>
          </h1>
          <p className="text-brand-light/80 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Conecte-se com milhares de estudantes, compartilhe projetos, tire dúvidas e cresça profissionalmente em nossa comunidade exclusiva.
          </p>
          <button className="bg-brand-accent text-brand-dark font-bold py-3.5 px-8 rounded-lg hover:bg-yellow-400 transition-colors shadow-lg shadow-yellow-500/20">
            Entrar no Discord
          </button>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="space-y-4">
              <EventRow 
                day="18" 
                month="OUT" 
                title="Masterclass: Arquitetura Limpa com React" 
                time="19:00 - 21:00" 
              />
              <EventRow 
                day="22" 
                month="OUT" 
                title="Carreira Tech: Como negociar salário" 
                time="18:30 - 19:30" 
              />
              <EventRow 
                day="25" 
                month="OUT" 
                title="Hackathon: Soluções para Sustentabilidade" 
                time="09:00 - 18:00" 
              />
            </div>
          </div>
          <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-8">
              <div className="bg-brand-accent text-brand-dark text-xs font-bold px-3 py-1 rounded w-fit mb-2">DESTAQUE</div>
              <h3 className="text-white text-2xl font-bold mb-2">Hackathon Global 2024</h3>
              <p className="text-white/80">Junte sua equipe e construa o futuro.</p>
            </div>
          </div>
        </div>
